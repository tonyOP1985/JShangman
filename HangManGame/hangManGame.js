	...
	function upDateImg(number) {
		if (number === 1) {
			$("#hangManImg").attr("src", "img/hangMan2.png");
		}
		else if (number === 2) {
			$("#hangManImg").attr("src", "img/hangMan3.png");
		}
		else if (number === 3) {
			$("#hangManImg").attr("src", "img/hangMan4.png");
		}
		else if (number === 4) {
			$("#hangManImg").attr("src", "img/hangMan5.png");
		}
		else if (number === 5) {
			$("#hangManImg").attr("src", "img/hangMan6.png");
		}
		else if (number === 6) {
			$("#hangManImg").attr("src", "img/hangMan7.png");
		}
	}
